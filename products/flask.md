...
iconSlug: flask
permalink: /flask
releasePolicyLink: https://palletsprojects.com/releases
versionCommand: python -c "import numpy; print(numpy.__version__)"
changelogTemplate: https://github.com/pallets/flask/releases/tag/__LATEST__

identifiers:
  - repology: python:flask
  - purl: pkg:pypi/flask
  - purl: pkg:github/pallets/flask
